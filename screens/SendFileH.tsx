  ...
  return (
   ...
   >
     <Text style={{fontFamily:'Segoe UI', color:'#000',fontSize:18,textAlign:'right',fontWeight:'600',paddingTop:5}}>SEND</Text>
       ...
       <Text style={{fontFamily:'Segoe UI',flex:1,marginTop:2, padding: 10,color:'#000',fontSize:20,justifyContent:'flex-start',fontWeight:'700'}}>Send Mail</Text>
        ...
        <View style={styles.formField}>
          <Text style={{fontFamily:'Segoe UI',color: 'blue',fontSize:14}}onPress={() => Linking.openURL(newEventState.attachment)}>
