  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <FlatList
          ...
          <View style={(!item.file?.mimeType?.includes('image')) ? 
    ...
    try {
      ...
      Promise.all(
          ...
          //  console.log('itemiddddd '+item.remoteItem.parentReference.driveId)
           ...
           const photos1=(thumbnailitems.value).filter((user:any)=>user.thumbnails&&user.thumbnails.length>0&&thumbnailitems.value&&thumbnailitems.value.length>0&&user.file?.mimeType.includes("application"))
